...
export const SERVICES = [
  {
    title: 'ПЕРЕЕЗД КВАРТИРЫ, ОФИСА В МИНСКЕ',
    description: 'Мы предоставляем услуги квартирных и офисных переездов с участием опытных и квалифицированных грузчиков. Наши специалисты не только аккуратно упакуют и надежно транспортируют ваше имущество, но и обеспечат бережное обращение с мебелью и техникой на каждом этапе.',
    img: removal
  },
  {
    title: 'ПРОФЕССИОНАЛЬНЫЕ ГРУЗЧИКИ',
    description: 'Мы предоставляем услуги профессиональных грузчиков. Наши сотрудники аккуратно и быстро выполнят погрузку и разгрузку ваших вещей, будь то мебель, техника или любые другие грузы. ругие грузы. Грузчики имеют опыт работы с различными типами грузов и помогут вам сэкономить время и силы при переезде или доставке.',
    img: loader
  },
  {
    title: 'ПЕРЕВОЗКИ ПО МИНСКУ И БЕЛАРУСИ',
    description: 'Идеальное решение для доставки грузов по Минску и РБ. Мы обеспечиваем быстрые и безопасные перевозки грузов в пределах города, области и по всей стране. Наша команда гарантирует оперативность и внимание к каждому заказу.',
    img: city
  },
]
